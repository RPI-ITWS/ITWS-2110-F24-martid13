I created a weather and currency exchange dashboard that dynamically displays current exchange information from Frankfurter and weater data from OpenWeatherMap.
